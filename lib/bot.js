    ...
    return new promise(function(resolve, reject)
    {
        ...
        if (plugin) {
                ...
                // promise!
            {
                ...
                {
                    var res = respond(to, from, message);
                    if (res && res.message && res.message.text) return resolve(res);
                    return resolve(null);
                }, function(err)
                {
                    reject(err);
            ...
            {
                var res = respond(to, from, response);
                if (res && res.message && res.message.text) {
                    return resolve(res);
                }
                return resolve(null);
            }
